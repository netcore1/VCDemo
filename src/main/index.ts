...
export default class WordCounter {
  ...
  public async getFiles() {
    ...
    try {
      ...
      let res = await vscode.workspace.findFiles('**/*')
      ...
      res = await vscode.workspace.findFiles('**/*.js') //, '∕node_modules∕**', 20
      ...
      vscode.workspace.findFiles(`{**/*.ts,**/*.vue}`).then((files: vscode.Uri[]) => {
